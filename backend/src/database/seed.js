...
// ********
    const restaurants = [
        // Zone 1 – Central
        { name: 'Trattoria Roma', cuisine: 'Italian', delivery_zone_id: 1, delivery_fee: 0, minimum_order_value: 15 },
        { name: 'Wiener Stube', cuisine: 'Austrian', delivery_zone_id: 1, delivery_fee: 0, minimum_order_value: 18 },
        { name: 'Green Bowl', cuisine: 'Vegetarian', delivery_zone_id: 1, delivery_fee: 1.49, minimum_order_value: 12 },
        { name: 'Sakura Central', cuisine: 'Japanese', delivery_zone_id: 1, delivery_fee: 2.49, minimum_order_value: 0 },

        // Zone 2 – North
        { name: 'Burger Werk', cuisine: 'Burgers', delivery_zone_id: 2, delivery_fee: 1.99, minimum_order_value: 10 },
        { name: 'Bombay Spice', cuisine: 'Indian', delivery_zone_id: 2, delivery_fee: 2.99, minimum_order_value: 15 },
        { name: 'Pizza Nord', cuisine: 'Italian', delivery_zone_id: 2, delivery_fee: 0, minimum_order_value: 0 },
        { name: 'Asia Wok Express', cuisine: 'Asian', delivery_zone_id: 2, delivery_fee: 2.49, minimum_order_value: 12 },
        { name: 'Anatolia Kebap', cuisine: 'Kebab', delivery_zone_id: 2, delivery_fee: 1.99, minimum_order_value: 10 },

        // Zone 3 – South
        { name: 'Schnitzel Haus', cuisine: 'Austrian', delivery_zone_id: 3, delivery_fee: 2.99, minimum_order_value: 10 },
        { name: 'Pho Saigon', cuisine: 'Asian', delivery_zone_id: 3, delivery_fee: 2.49, minimum_order_value: 15 },
        { name: 'Veggie South', cuisine: 'Vegetarian', delivery_zone_id: 3, delivery_fee: 0, minimum_order_value: 0 },
        { name: 'Istanbul Grill', cuisine: 'Kebab', delivery_zone_id: 3, delivery_fee: 2.99, minimum_order_value: 12 },

        // Zone 4 – Industrial
        { name: 'Factory Bites', cuisine: 'Fast Food', delivery_zone_id: 4, delivery_fee: 3.49, minimum_order_value: 0 },
        { name: 'Grill Station', cuisine: 'Burgers', delivery_zone_id: 4, delivery_fee: 3.99, minimum_order_value: 15 },
        { name: 'Pasta Depot', cuisine: 'Italian', delivery_zone_id: 4, delivery_fee: 2.99, minimum_order_value: 12 },
    ...
    restaurants.forEach(restaurant => {
        db.run(
            ...
            [restaurant.name, restaurant.cuisine, restaurant.delivery_zone_id, restaurant.delivery_fee, restaurant.minimum_order_value],
            (err) => {
                if (err) {
